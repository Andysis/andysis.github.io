...
我以第一作者或通讯作者发表40余篇高水平论文，其中包括**8篇**影响因子大于10的顶级期刊论文（Medical Image Analysis, IEEE Transactions on Medical Imaging），以及**25篇**发表于IEEE JBHI、NeurIPS、ICCV、MICCAI、AAAI、IJCAI、ACM MM等国际顶级期刊与会议。此外，我已获授权或公开发明专利10余项。
